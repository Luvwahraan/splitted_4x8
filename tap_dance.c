...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TDYLALT]     = ACTION_TAP_DANCE_DOUBLE(BP_Y,     BP_LSUPER),
  ...
  [TDRSW]       = ACTION_HOLD_TAP(BP_W, KC_RSHIFT),
  [TDRSM]       = ACTION_HOLD_TAP(BP_M, KC_RSHIFT),

  // ACTION_HOLD_DTAP(Hold, tap, double tap, double tap hold)
  [TDLSAGRV]    = ACTION_HOLD_DTAP(BP_AGRV,  KC_LSHIFT, BP_AGRV,    BP_AGRV),
  [TDRSW]       = ACTION_HOLD_DTAP(BP_AGRV,  KC_RSHIFT, BP_AGRV,    BP_AGRV),
